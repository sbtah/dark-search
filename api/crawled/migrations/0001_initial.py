    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('linking_to_webpages', models.ManyToManyField(blank=True, related_name='_linking_from_webpages', to='crawled.webpage')),
                ('parent_domain', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='crawled.domain')),
                ('tags', models.ManyToManyField(blank=True, to='crawled.tag')),
            ],
            options={
                'db_table': 'webpages',
